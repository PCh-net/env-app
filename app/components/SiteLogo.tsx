...
const SiteLogo: React.FC<SiteLogoProps> = ({ site }) => {
  if (site.includes("themeforest.net")) {
    return <img className="w-full m-2" alt="Logo-EnvatoMarket-Themeforest-Dark" src="/images/logos/EnvatoMarket-Themeforest-Dark.png" />;
  } else if (site.includes("videohive.net")) {
    return <img className="w-full m-2" alt="EnvatoMarket-Videohive-Dark" src="/images/logos/EnvatoMarket-Videohive-Dark.png" />;
  } else if (site.includes("photodune.net")) {
    return <img className="w-full m-2" alt="EnvatoMarket-Photodune-Dark" src="/images/logos/EnvatoMarket-Photodune-Dark.png" />;
