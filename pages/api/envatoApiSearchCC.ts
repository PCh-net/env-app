...
export default async function handler(
  ...
  const productDetailsUrl = `https://api.envato.com/v1/discovery/search/search/item?category=${categoryName}&page=${page}&page_size=${pageSize || 12}&site=codecanyon.net&sort_by=trending`;
